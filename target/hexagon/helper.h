...
DEF_HELPER_2(conv_w2df, s64, env, s32)
DEF_HELPER_2(conv_ud2sf, s32, env, s64)
DEF_HELPER_2(conv_ud2df, s64, env, s64)
DEF_HELPER_2(conv_d2sf, s32, env, s64)
DEF_HELPER_2(conv_d2df, s64, env, s64)
DEF_HELPER_2(conv_sf2uw, s32, env, s32)
DEF_HELPER_2(conv_sf2w, s32, env, s32)
DEF_HELPER_2(conv_sf2ud, s64, env, s32)
DEF_HELPER_2(conv_sf2d, s64, env, s32)
DEF_HELPER_2(conv_df2uw, s32, env, s64)
DEF_HELPER_2(conv_df2w, s32, env, s64)
DEF_HELPER_2(conv_df2ud, s64, env, s64)
DEF_HELPER_2(conv_df2d, s64, env, s64)
DEF_HELPER_2(conv_sf2uw_chop, s32, env, s32)
DEF_HELPER_2(conv_sf2w_chop, s32, env, s32)
DEF_HELPER_2(conv_sf2ud_chop, s64, env, s32)
DEF_HELPER_2(conv_sf2d_chop, s64, env, s32)
DEF_HELPER_2(conv_df2uw_chop, s32, env, s64)
